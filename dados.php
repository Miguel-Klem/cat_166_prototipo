...
/* =========================================================
   ...
   Este arquivo é 100% PHP: não tem nenhum HTML de visualização.
   Ele só monta os dados (esportes, cursos, depoimentos, galeria,
   planos) e devolve em formato JSON, para o index.html buscar
   com JavaScript e montar a página.
   ========================================================= */
...
$depoimentos = [
    ...
    ['nome' => 'André Luis Denani', 'papel' => 'Aluno de música', 'foto' => 'depoimento-3.jpg', 'texto' => 'Comecei no curso de percursão sem saber nada, e hoje já toco em apresentações.'],
];
...
echo json_encode(
    compact('esportes', 'cursos', 'depoimentos', 'galeria', 'planos'),
